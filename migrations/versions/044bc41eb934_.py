...
Revision ID: 044bc41eb934
Revises: 
Create Date: 2021-10-24 11:56:45.986672
...
def upgrade():
    ...
    op.create_index(op.f('ix_homework_email'), 'homework', ['email'], unique=True)
    op.create_index(op.f('ix_homework_username'), 'homework', ['username'], unique=True)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_homework_username'), table_name='homework')
    op.drop_index(op.f('ix_homework_email'), table_name='homework')
